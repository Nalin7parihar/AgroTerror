...
config = config('/data/data2/liuxiuqin/JYJ/pygall/gat/config_117testset.json')
...
class RnaPredictionDataset(InMemoryDataset):
    ...
    def process(self):
        data_list = []
        df = pd.read_csv('/data/data2/liuxiuqin/JYJ/dataset/update_data/kim2019/20rna_testset/kim500.csv', nrows=config.length)
