...
from datasetBE import get_data, get_test_data
...
def evaluate(model, crit, graph_val_loader):
    ...
    # valid_mask = np.isfinite(all_outputs) & np.isfinite(all_label)
...
def initialize_model(config, hidden_dim, dropout, activation_name, conv_layer, pool_layer, global_pool_layer, lr,
    ...
    # model_pathold = '/data/data2/liuxiuqin/JYJ/pygall/gat/adjust_model/bestmodel_official/best_model_fold5_epoch90.pt'
    # model = load_checkpoint('/data/data2/liuxiuqin/JYJ/pygall/gat/adjust_model/bestmodel_official/best_model_fold5_epoch90.pt')
    # model = model.cuda()
    # model = Net(
...
if __name__ == "__main__":
    ...
    config_file_path = '/data/data2/liuxiuqin/JYJ/pygall/gat/config_BE.json' 
    ...
    best_model = None
    best_model_dir = '/data/data2/liuxiuqin/JYJ/pygall/gat/adjust_model/bestmodelBE'
    ...
    excel_path_best = '/data/data2/liuxiuqin/JYJ/pygall/gat/adjust_output/6fold_BE85%_best_results.xlsx'
